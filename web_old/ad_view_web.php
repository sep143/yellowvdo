                                ...
                                <div class="item-title-single">
                                    ...
                                    <div class="item-meta">
                                        <ul style="color: rgba(0,47,52,.7); font-weight: 400;">
                                            ...
                                            <li class="item pull-right"><span class="btn btn-xs btn-success"><?php if(!empty($review_count->review)) {echo $review_count->review; }else{ echo '0';} ?></span> &nbsp;&nbsp;
                                                <?php
...
<!--                                                <div class="tab-pane fade" id="tab2default">
                                                ...
                                                <div class="tab-pane fade" id="review">
                                                    ...
                                                    <form id="review_form" action="" method="get">
                                                        ...
                                                        &nbsp; <br>
                                                        <div class="form-group">
                                                            <button type="button" onclick="submit_rating(this)" class="btn btn-block btn-lg btn-primary1">Submit</button>
                                                        </div>
                                                    </form>
                    ...
                    <div class="widget-body">
                        <ul class="trends">
                            ...
                            if($ad_view->Url2Show == 1){
                                ...
                                echo '<li style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;"><a href="'.$ad_view->Url2.'" target="_blank"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> '.$ad_view->Url2.'</a></li>';
                            }
                            if($ad_view->Url3Show == 1){
                                if(!empty($ad_view->Url3))
                                echo '<li style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;"><a href="'.$ad_view->Url3.'" target="_blank"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> '.$ad_view->Url3.'</a></li>';
                            }
                            if($ad_view->Url4Show == 1){
                                if(!empty($ad_view->Url4))
                                echo '<li style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;"><a href="'.$ad_view->Url4.'" target="_blank"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> '.$ad_view->Url4.'</a></li>';
                            }
                            if($ad_view->Url5Show == 1){
                                if(!empty($ad_view->Url5))
                                echo '<li style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;"><a href="'.$ad_view->Url5.'" target="_blank"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> '.$ad_view->Url5.'</a></li>';
                            }
                            ?>
                        </ul>
                    </div>
