        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                ...
                <div class="widget top-space margin-bottom-none">
                    ...
                    <form method="POST" action="<?= site_url('mail_admin'); ?>" id="contactForm" novalidate="novalidate">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="control-label">Your Name <span class="required">*</span></label>
                                    <input type="text" name="name" value="" placeholder="Enter Name" class="form-control" maxlength="100" required="">
                                </div>
                                <div class="col-md-6">
                                    <label class="control-label">Your Contact No. <span class="required">*</span></label>
                                    <input type="text" name="mobile" value="" placeholder="Enter Contact No." class="form-control" required="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Your Email Address <span class="required">*</span></label>
                            <input type="email" name="email" value="" placeholder="Enter Email Address" class="form-control" required="">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Subject</label>
                            <input type="text" name="subject" value="" placeholder="Enter The Subject" class="form-control" required="">
                        </div>
                        <div class="form-group">
