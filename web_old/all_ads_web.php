                                            ...
                                            <ul class="dropdown-menu" style="padding: 5px;">
                                                    ...
                                                    <li>
                                                        <form action="<?= site_url('sort'); ?>" method="get">
                                                            <input style="margin-top: 2px;" type="submit" value="Popular" name="sort" class="btn2 btn-primary1 btn-xs simple-btn btn-block">
                                                        </form>
                                                    </li>
                                                    <li>
                                                        <form action="<?= site_url('sort'); ?>" method="get">
                                                            <input style="margin-top: 8px;" type="submit" value="Recently" name="sort" class="btn2 btn-primary1 btn-xs simple-btn btn-block">
                                                        </form>
                                                    </li>
                                                    <li>
                                                        <form action="<?= site_url('sort'); ?>" method="get">
                                                            ...
                                                            <input style="margin-top: 8px;" type="submit" value="Nearby" name="sort" class="btn2 btn-primary1 btn-xs simple-btn btn-block">
                                                        </form>
                                                    </li>
                                                    ...
                                                    <a class="" href="<?= site_url('view/'.$row->ID); ?>" target="_blank">
                                                        <div class="row">
                                                            <div class="col-md-3 col-xs-12">
                                                                ...
                                                                ?>
                                                                <img alt="" src="<?= $image; ?>" style="width: 250px; height: 215px; object-fit: cover; min-width: 100%;" class="responsive img-responsive img-center" >
<!--                                                         <div class="item-title">
                                                            ...
                                                            <div class="col-md-9 col-xs-12" style="padding: 20px;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 col-xs-12">
                                                                        <span class="text-justify" style="color: #000;"><?= $row->CaptionLine; ?></span>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12 col-xs-12">
                                                                        <span><i class="fa fa-map-marker"></i> &nbsp; <?= $row->BusinessAddress; ?></span>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
