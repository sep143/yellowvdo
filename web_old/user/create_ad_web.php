...
<!--                                    <div class="form-group">
            ...
            <div class="form-group">
               ...
               <input type="text" name="businessname" placeholder="e.g. Xyz Restaurant/Hotel, Univercity" required="required" value="" class="form-control border-form">
            </div>
            <div class="form-group">
               <label class="control-label">Advertisement Title / Caption Line <span class="required">*</span></label>
               <input type="text" name="captionline" placeholder="e.g. Food Ads" required="required" value="" class="form-control border-form">
            </div>
            <div class="form-group">
               <div class="row">
                   <div class="col-md-12 col-xs-12">
                     <label class="control-label">Description <span class="required">*</span></label>
                     <textarea rows="10" style="width: 100%;" id="editor2" class="form-control border-form" required="" name="description"></textarea>
                   </div>
               </div>
            </div>
            <div class="form-group">
               <label class="control-label">Key Word <span class="required">*</span></label>
               <input type="text" name="keyword" placeholder="e.g. car,jobs etc." required="required" value="" class="form-control border-form">
            </div>
            <div class="form-group">
               <div class="row">
                  ...
                  <div class="col-sm-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         ...
                         <label class="check" for="c1" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
                   ...
                   <div class="col-md-6 col-xs-12">
                       <div class="row">
                           <div class="col-md-10 col-xs-8">
                               ...
                               <input type="text" name="whatsappNo" id="whatsappNo" placeholder="e.g. 9000000001" class="form-control border-form">
                           </div>
                           <div class="col-md-2 col-xs-4">
                               <div class="checkboxes" style="margin-top: 15px;">
                                   ...
                                   <label class="check" for="c2" title="Show Tic"></label>
                               </div>
                           </div>
                       </div>
                   </div>
                   <div class="col-md-6 col-xs-12">
                       <div class="row">
                           <div class="col-md-10 col-xs-8">
                               ...
                               <input type="text" name="cellNo" id="phone1" placeholder="e.g. 800000009" class="form-control border-form">
                           </div>
                           <div class="col-md-2 col-xs-4">
                               <div class="checkboxes" style="margin-top: 15px;">
                                   <input type="hidden" value="0" name="cellNoShow">
                                   <input type="checkbox" value="1" name="cellNoShow" id="c3" checked="checked" />
                                   <label class="check" for="c3" title="Show Tic"></label>
                               </div>
                           </div>
                       </div>
                   </div>
            ...
            <div class="form-group">
               <div class="row">
                   <div class="col-md-11 col-xs-9">
                     ...
                     <input type="text" name="landLine" id="landLine" placeholder="e.g. 024812345678" value="" class="form-control border-form">
                   </div>
                  <div class="col-md-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         <input type="hidden" value="0" name="landLineShow">
                         <input type="checkbox" value="1" name="landLineShow" id="c4" checked="checked" />
                         <label class="check" for="c4" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="form-group">
               <div class="row">
                   <div class="col-md-11 col-xs-9">
                     ...
                     <input type="text" name="url1" placeholder="e.g. www.domainname.com" value="" class="form-control border-form">
                   </div>
                   <div class="col-md-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         <input type="hidden" value="0" name="url1Show">
                         <input type="checkbox" value="1" name="url1Show" id="c5" checked="checked" />
                         <label class="check" for="c5" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="form-group">
               <div class="row">
                   <div class="col-md-11 col-xs-9">
                     ...
                     <input type="text" name="url2" placeholder="e.g. http://example.com" value="" class="form-control border-form">
                   </div>
                   <div class="col-md-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         <input type="hidden" value="0" name="url2Show">
                         <input type="checkbox" value="1" name="url2Show" id="c6" checked="checked" />
                         <label class="check" for="c6" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
            <div class="form-group">
               <div class="row">
                   <div class="col-md-11 col-xs-9">
                     ...
                     <input type="text" name="url3" placeholder="e.g. http://example.in" value="" class="form-control border-form">
                   </div>
                   <div class="col-md-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         <input type="hidden" value="0" name="url3Show">
                         <input type="checkbox" value="1" name="url3Show" id="c7" checked="checked" />
                         <label class="check" for="c7" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
            <div class="form-group">
               <div class="row">
                   <div class="col-md-11 col-xs-9">
                     ...
                     <input type="text" name="url4Show" placeholder="e.g. http://fb.com/id" value="" class="form-control border-form">
                   </div>
                   <div class="col-md-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         <input type="hidden" value="0" name="url4Show">
                         <input type="checkbox" value="1" name="url4Show" id="c8" checked="checked" />
                         <label class="check" for="c8" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
            <div class="form-group">
               <div class="row">
                   <div class="col-md-11 col-xs-9">
                     ...
                     <input type="text" name="url5Show" placeholder="e.g. http://twitter.com/id" value="" class="form-control border-form">
                   </div>
                   <div class="col-md-1 col-xs-3">
                     <div class="checkboxes" style="margin-top: 40px;">
                         <input type="hidden" value="0" name="url5Show">
                         <input type="checkbox" value="1" name="url5Show" id="c9" checked="checked" />
                         <label class="check" for="c9" title="Show Tic"></label>
                     </div>
                  </div>
               </div>
            </div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-2 col-xs-3">
                                 <div class="checkboxes" style="margin-top: 40px;">
                                     ...
                                     <label class="check" for="c11" title="Show Tic"></label>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-2 col-xs-3">
                                 <div class="checkboxes" style="margin-top: 40px;">
                                     ...
                                     <label class="check" for="c12" title="Show Tic"></label>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-2 col-xs-3">
                                 <div class="checkboxes" style="margin-top: 40px;">
                                     ...
                                     <label class="check" for="c13" title="Show Tic"></label>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-2 col-xs-3">
                                 <div class="checkboxes" style="margin-top: 40px;">
                                     ...
                                     <label class="check" for="c14" title="Show Tic"></label>
                                 </div>
                             </div>
                         </div>
                         &nbsp;<br>
                         <div class="row">
                             ...
                             <div class="col-md-2 col-xs-3">
                                 <div class="checkboxes" style="margin-top: 40px;">
                                     ...
                                     <label class="check" for="c15" title="Show Tic"></label>
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                             ...
                             <div class="col-md-2 col-xs-3">
                                 <div class="checkboxes" style="margin-top: 40px;">
                                     ...
                                     <label class="check" for="c16" title="Show Tic"></label>
                                 </div>
                             </div>
                         </div>
                     </div>
...
<!--                     <div class="col-md-3 col-xs-6 text-center">
                         <center style="width:150px; height:150px; max-width: 150px; max-height: 150px; border: 1px solid #0000ff; cursor: pointer;" id="img_div_1">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                     ...
                     <div class="col-md-3 col-xs-6 text-center" >
                         <center style="width:150px; height:150px; max-width: 150px; max-height: 150px; border: 1px solid #0000ff; cursor: pointer;" id="img_div_2">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                     ...
                     <div class="col-md-3 col-xs-6 text-center">
                         <center style="width:150px; height:150px; max-width: 150px; max-height: 150px; border: 1px solid #0000ff; cursor: pointer;" id="img_div_3">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                     ...
                     <div class="col-md-3 col-xs-6 text-center">
                         <center style="width:150px; height:150px; max-width: 150px; max-height: 150px; border: 1px solid #0000ff; cursor: pointer;" id="img_div_4">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                             ...
                             <div class="row">
                                 <div class="col-md-12 col-xs-12" id="type_append">
                                     <div id="select_div">
                                        ...
                                        <input type="file" name="video" class="file_multi_video" id="select_video" accept="video/*" required=""/>
                                     </div>
             ...
             <div class="row">
                 <div class="col-sm-11 col-xs-9">
                     <div class="checkboxes">
                         ...
                         <label class="check" for="c17" title="Show Tic"></label>
