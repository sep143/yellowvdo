...
<!--                                    <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="businessname" placeholder="e.g. Xyz Restaurant/Hotel, Univercity" required="required" value="<?= $ads->BusinessName; ?>" class="form-control border-form">
                           </div>
                           <div class="form-group">
                              <label class="control-label">Advertisement Title / Caption Line <span class="required">*</span></label>
                              <input type="text" name="captionline" placeholder="e.g. Food Ads" required="required" value="<?= $ads->CaptionLine; ?>" class="form-control border-form">
                           </div>
                           <div class="form-group">
                              <div class="row">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="keyword" placeholder="e.g. car,jobs etc." required="required" value="<?= $ads->Keyword; ?>" class="form-control border-form">
                           </div>
                           <div class="form-group">
                              <div class="row">
                                 ...
                                 <div class="col-md-1 col-xs-3">
                                    <div class="checkboxes" style="margin-top: 40px;">
                                        ...
                                        <input type="checkbox" name="emailShow" id="email" value="1" id="c1" <?php if($ads->EmailShow == 1) echo 'checked=""'; ?> />
                           ...
                           <div class="form-group">
                              <div class="row">
                                  <div class="col-md-11 col-xs-9">
                                    ...
                                    <input type="text" name="url4Show" placeholder="e.g. http://fb.com/id" value="<?= $ads->Url4; ?>" class="form-control border-form">
                                  </div>
                                  <div class="col-md-1 col-xs-3">
                                    <div class="checkboxes" style="margin-top: 40px;">
                           ...
                           <div class="form-group">
                              <div class="row">
                                  <div class="col-md-11 col-xs-9">
                                    ...
                                    <input type="text" name="url5Show" placeholder="e.g. http://twitter.com/id" value="<?= $ads->Url5; ?>" class="form-control border-form">
                                  </div>
                                  <div class="col-md-1 col-xs-3">
                                    <div class="checkboxes" style="margin-top: 40px;">
