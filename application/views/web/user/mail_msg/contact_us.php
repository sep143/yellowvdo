											...
											<tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0">
                                                                                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; vertical-align:top; margin:0; padding:0 0 20px" valign="top">&nbsp;<br>&nbsp;<br>
                                                                                                <fieldset>
                                                                                                    ...
                                                                                                    <table class="table-ads" border="1" width="100%" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                                                                                        width:100%;
                                                                                                        border-collapse: collapse; 
                                                                                                        font-size:13px!important; 
                                                                                                        text-align:left; border-collapse: collapse; padding: 5px;">
                                                                                                        <tbody>
                                                                                                            <tr><th style="padding: 5px;">Contact Name</th><td style="padding: 5px;"><?=$name;?></td></tr>
                                                                                                            <tr><th style="padding: 5px;">Contact No.</th><td style="padding: 5px;"><?=$phone;?></td></tr>
                                                                                                            <tr><th style="padding: 5px;">Email Address</th><td style="padding: 5px;"><?=$email;?></td></tr>
                                                                                                        </tbody>
                                                                                                    </table>
                                                                                            </td>
											</tr>
                                                                                        <tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0">
                                                                                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; vertical-align:top; margin:0; padding:0 0 20px" valign="top">
                                                                                                <strong><u>Subject</u> :- <?= $subject;?></strong>
                                                                                            </td>
											</tr>
                                                                                        <tr style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; margin:0">
                                                                                            <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing:border-box; font-size:14px; vertical-align:top; margin:0; padding:0 0 20px" valign="top">
