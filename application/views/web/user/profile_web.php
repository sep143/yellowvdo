                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control border-form" type="text" name="first_name" value="<?= $user_data->FirstName; ?>" maxlength="20" placeholder="Enter First Name">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="control-label">Last Name <span class="required">*</span></label>
                            <input class="form-control border-form" type="text" name="last_name" value="<?= $user_data->LastName; ?>" maxlength="20" placeholder="Enter Last Name">
                        </div>
                    </div>
                </div>
                <div class="form-group">
