            ...
            <div class="col-md-8 col-lg-8">
                <div class="login-panel widget">
                    <div class="login-body">
                        <form action="<?= site_url('user_register'); ?>" method="post" onkeypress="return event.keyCode != 13;">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label">First Name <span class="required">*</span></label>
                                        <input type="text" name="fname" placeholder="First Name" value="<?= set_value('fname'); ?>" maxlength="20" class="form-control" required="">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lname" placeholder="Last Name" value="<?= set_value('lname'); ?>" maxlength="20" class="form-control" required="">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile" id="whatsappNo" placeholder="e.g. 9000000001" maxlength="13" class="form-control border-form" value="<?= set_value('mobile'); ?>">
...
<tr>
 ...
 <td class="wideField" colspan="2">
     <input type="hidden" class="field" id="route" disabled="true"/></td>
                 ...
                 &nbsp;<br>
                            <div class="form-group">
                                <p style="font-size:10px; text-align:center; color:#000;">By logging in you agree to our <u><a href="#" target="_blank">Terms & Services</a></u> and <u><a href="<?= site_url('privacy_policy'); ?>" target="_blank">Privacy Policies</a></u>.</p>
...
function initialize(position) {
    ...
    if(latitude && longitude){
       ...
       var latitude = '24.580327';
       var longitude = '73.7221453';
    }
