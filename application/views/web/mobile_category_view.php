                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <input style="padding: 25px; zoom:140%;" type="input" class="form-control" id="input-search" placeholder="Search Category..." value="" aria-describedby="basic-addon1">
                                                    </div>
                                                    <div class="col-xs-2">
...
<!--                                                        <button type="button" class="btn btn-default ok" data-dismiss="modal">OK</button>-->
                                        ...
                                        <div class="row" style="margin-top: 5px;">
                                            <div class="col-xs-12">
                                                <button type="button" class="btn btn-primary1 btn-block ok" data-dismiss="modal" style="font-size:15px; zoom:130%;">OK</button>
                                            </div>
                                        </div>
