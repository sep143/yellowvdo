...
echo '<ul class="trends" >';
    ...
    foreach ($sub_category as $row):
        echo '<li>'
        . '<a href="'.site_url('category-wise/ads/' . $row->ID).'" style="color: rgba(0,47,52,.7); font-weight: 400;"><b>'.$row->Name.'</b>'
           // . '<small class="item-numbers1 pull-right" id="ads_count'.$row->ID.'"></small>'
            . '</a></li>';
       // echo '<li>'.$v.'</li>';
        $v++;
    endforeach;
