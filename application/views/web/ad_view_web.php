                                    ...
                                    <div class="item-meta">
                                        <ul style="color: rgba(0,47,52,.7); font-weight: 400;">
                                            ...
                                            <li class="item pull-right">
                                                <span class="btn btn-xs btn-success"><?php if(!empty($review_count->review)) {echo number_format($review_count->review,2); }else{ echo '0';} ?></span> &nbsp;&nbsp;
                                                <?php
                                    ...
                                    <div id="sync2" class="owl-carousel" style="height: 130px; margin-left: 2px;">
                                        <?php
                                         if(empty($check_store)){
                                             ?>
                                        <div class="item">
                                            <video style="width: 100%; height: 120px;">
                                                <source src="<?= $ad_view->Video; ?>" >
                                            </video>
                                        </div>
                                        <?php
...
<!--                           <i class="fa fa-map-marker"></i> Location: <strong>Orlando</strong><br>
        ...
        // echo '<li><a href="#" ><i class="fa fa-fw fa-mobile"></i> *****</a></li>';
                                    ...
                                    if($ad_view->BusinessAddressShow == 1){
                                        if($ad_view->LandmarkAddressShow == 1){
                                            $landmark = ' ,('.$ad_view->LandmarkAddress.')';
                                        }
                                        if(!empty($ad_view->BusinessAddress)){
                                            echo '<li><i class="fa fa-fw fa-map-marker" style="color: #4611A7;"></i> &nbsp;'.$ad_view->BusinessAddress.$landmark.'</li>';
                                        }
                                    }else{
                ...
                <div class="widget listing-filter-block filter-categories margin-bottom-none">
                    ...
                    <div class="widget-body">
                        ...
                        <?php
                            ...
                            ?> 
                            <li><a href="<?php if(substr($ad_view->Url1, 0, 7) != "http://" && substr($ad_view->Url1, 0, 8) != "https://") {echo 'http://' . $ad_view->Url1;}else{echo $ad_view->Url1;}?>" style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;" target="_blank" title="<?= $ad_view->Url1 ?>"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> &nbsp;<?= mb_strimwidth($ad_view->Url1, 0, 42,"...")?></a></li>
                            <?php
                            } 
                            }
                            ...
                            ?>
                            <li><a href="<?php if(substr($ad_view->Url2, 0, 7) != "http://" && substr($ad_view->Url2, 0, 8) != "https://") {echo 'http://' . $ad_view->Url2;}else{echo $ad_view->Url2;}?>" style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;" target="_blank" title="<?= $ad_view->Url2 ?>"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> &nbsp;<?= mb_strimwidth($ad_view->Url2, 0, 42, "...");?></a></li>
                            <?php 
                            }
                            }
                            ...
                            ?>
                            <li><a href="<?php if(substr($ad_view->Url3, 0, 7) != "http://" && substr($ad_view->Url3, 0, 8) != "https://") {echo 'http://' . $ad_view->Url3;}else{echo $ad_view->Url3;}?>" style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;" target="_blank" title="<?= $ad_view->Url3 ?>"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> &nbsp;<?= mb_strimwidth($ad_view->Url3, 0, 42,"..."); ?></a></li>
                            ...
                            ?> 
                            <li><a href="<?php if(substr($ad_view->Url4, 0, 7) != "http://" && substr($ad_view->Url4, 0, 8) != "https://") {echo 'http://' . $ad_view->Url4;}else{echo $ad_view->Url4;}?>" style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;" target="_blank" title="<?= $ad_view->Url4 ?>"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> &nbsp;<?= mb_strimwidth($ad_view->Url4, 0, 42,"..."); ?></a></li>
                            <?php 
                            }
                            }
                            ...
                            ?> 
                            <li><a href="<?php if(substr($ad_view->Url5, 0, 7) != "http://" && substr($ad_view->Url5, 0, 8) != "https://") {echo 'http://' . $ad_view->Url5;}else{echo $ad_view->Url5;}?>" style="word-wrap: break-word; color: rgba(0,47,52,.7); font-weight: 400;" target="_blank" title="<?= $ad_view->Url5 ?>"><i class="fa fa-fw fa-globe" style="color: #4611A7;"></i> &nbsp;<?= mb_strimwidth($ad_view->Url5, 0, 42,"..."); ?></a></li>
                            <?php
                            } 
                            }
                            ?>
                ...
                <div class="widget listing-filter-block filter-categories margin-bottom-none">
                    ...
                    <div class="widget-body">
                        <div class="social-links social-bg ">
                            <ul>
                                <li><a class="fa fa-twitter" target="_blank" href="http://www.twitter.com/share?text=<?= $ad_view->BusinessName; ?>, click the below link to see details of ad - share via YellowVdo&url=<?= base_url(uri_string());?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"></a></li>
                                ...
                                <li><a class="fa fa-linkedin" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?= $ad_view->BusinessName; ?>, click the below link to see details of ad - <?= base_url(uri_string());?>, share via YellowVdo" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"></a></li>
                                <li>
                                    <a class="fa fa-whatsapp" target="_blank" href="https://wa.me/?text=<?= $ad_view->BusinessName; ?>, click the below link to see details of ad - <?= base_url(uri_string());?>, share via YellowVdo" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"></a></li>
                    ...
                    <div class="widget-body">
                        <div class="row" style="margin-top: -20px; margin-bottom: -13px; line-height: initial; color: rgba(0,47,52,.7); font-weight: 400;">
                            <div class="col-md-12 col-xs-12">
                                <small><?= $ad_view->BusinessAddress. $landmark; ?></small>
                            </div>
                        </div>
                        <hr>
                        <?php
...
$(document).ready(function(){
    ...
    if(video_sel_div){
        ...
        $('#video_here_youtube2').html('<iframe width="100%" height="120" src="//www.youtube.com/embed/' + myId + '" frameborder="0" allowfullscreen style="pointer-events:none!important;"></iframe>');
    }
