                                                    ...
                                                    <table class="table ">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>$ <?= $default_payment->Amt; ?></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tax <small style="color:red;">(<?= $default_payment->Tax; ?>%)</small></td>
                                                                <td>$ <?= number_format((($default_payment->Amt * $default_payment->Tax)/100),2); ?> </td>
                                                            </tr>
                                                        </tbody>
                                                        <tfoot>
                                                            <tr>
                                                                <td class="pull-right"> Total </td>
                                                                <td> <span style="color:green;">$ <?= $default_payment->Total; ?></span> </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
