                ...
                <div class="col-md-12" id="advertiser-list-table">
                    <div class="card">
                        <div class="card-header card-header-primary card-header-icon">
                            ...
                            <h4 class="card-title">Renew Advertisement List <button class="pull-right btn btn-rose" id="sendReminder">Send Reminder</button></h4>
                        </div>
                        <div class="card-body">
                            <div class="toolbar">
   ...
   $('#status_5').on('click', function(){
    ...
    function filter_get(){
         $.ajax({
            url:'<?= site_url('filter'); ?>',
            type:'post',
            data:{use:'renew',id:id_search,from:dateFrom,to:dateTo,location:location,status:status,category:category},
            success:function(data){
                $('#filter_data').empty();
