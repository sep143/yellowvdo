...
<!--                                                <li style="border-left: 2px solid lightgray;">
                            ...
                            <div class="material-datatables" id="filter_data">
                                <table id="advertisementDisapproveTable" class="table table-striped table-no-bordered table-hover dt-responsive" cellspacing="0" width="100%" style="width:100%">
                                    <thead>
                                        <tr>
...
<!--                                                <video style="width: 150px; height: auto;" controls>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    ?>
<!--                                                    <span class="btn btn-success" title="Approve" onclick="change_status(this)" data-status="1" data-id='<?= $row->ID; ?>'><i class="material-icons">done</i></span>
                                                    <span class="btn btn-danger" title="Disapprove" onclick="change_status(this)" data-status="4" data-id='<?= $row->ID; ?>'><i class="material-icons">clear</i></span>-->
  ...
  <script src="<?= base_url(); ?>theme/backend/image-crop/js/main.js"></script>
    ...
    <script>
        $(document).ready(function () {
            $('#advertisementDisapproveTable').DataTable({
   ...
   $('#status_5').on('click', function(){
    ...
    function filter_get(){
         $.ajax({
            url:'<?= site_url('filter'); ?>',
            type:'post',
            data:{use:'disApprove',id:id_search,from:dateFrom,to:dateTo,location:location,status:status},
            success:function(data){
                $('#filter_data').empty();
...
$("#downloadXls").click(function(){
  $("#advertisementDisapproveTable").table2excel({
    // exclude CSS class
    exclude: ".noExl",
    name: "Worksheet Name",
