                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div style="margin-top: 20px;"><!--This Div use to card body and form between space now then use div and set top margin-->
                                <form method="post" action="<?= site_url('free_ad_create'); ?>" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"> Category Select * </label>
                                            <input type="hidden" id="category_id" name="catid">
                                            <input type="text" class="form-control" id="category_view" required="" data-target="#bootstrap-modal" data-toggle="modal">
                                        </div>
<!--                                                <button type="button" class="btn btn-rose btn-round"  data-target="#bootstrap-modal" data-toggle="modal"><i class="material-icons">folder</i> Select Category</button>-->
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="captionline" required="">
                                        </div>
                                    </div>
                                </div>&nbsp;<br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-12">
                                        ...
                                        <div class="map" id="map" style="width: 100%; height: 430px; margin-top: 40px;"></div>
                                    <div class="form_area">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control pane" id="editor2" name="description" rows="14" ></textarea>
                                        </div>
                                    </div>
...
<!--  <script src="<?= base_url(); ?>theme/backend/image-crop/js/cropper.js"></script>
  ...
  $(document).ready(function(){
      $('#free_ad_post').addClass('btn-rose');
//      $('#free_ad_post').css('color','yellow');
      $('#free_ad_post').removeClass('btn-warning');
  });
  </script>
...
<script src="//cdnjs.cloudflare.com/ajax/libs/bootstrap-filestyle/2.1.0/bootstrap-filestyle.js"></script>
