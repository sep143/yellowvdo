                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-rose card-header-icon">
                            ...
                            <h4 class="card-title">Free Ads List</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <a href="<?= site_url('admin/view_ad/'.$value->ID); ?>" target="_blank" class="btn btn-link btn-info btn-just-icon" title="View ad"><i class="material-icons">visibility</i></a>
   ...
   $('#status_5').on('click', function(){
    ...
    function filter_get(){
         $.ajax({
            url:'<?= site_url('filter'); ?>',
            type:'post',
            data:{use:'free_ads',id:id_search,from:dateFrom,to:dateTo,location:location,status:status},
            success:function(data){
                $('#filter_data').empty();
