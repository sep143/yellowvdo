                ...
                <div class="col-md-12" id="advertiser-list-table">
                    <div class="card">
                        <div class="card-header card-header-primary card-header-icon">
                            ...
                            <h4 class="card-title">Pending Payment Advertisement List</h4>
                        </div>
                        <div class="card-body">
                            <div class="toolbar">
...
<!--                                            <ul class="nav navbar-default ">
                            ...
                            <div class="material-datatables" id="filter_data">
                                <table id="advertisementPayTable" class="table table-striped table-no-bordered table-hover dt-responsive" cellspacing="0" width="100%" style="width:100%">
                                    <thead>
                                        <tr>
  ...
  <script src="<?= base_url(); ?>theme/backend/image-crop/js/main.js"></script>-->
    ...
    <script>
        $(document).ready(function () {
            $('#advertisementPayTable').DataTable({
