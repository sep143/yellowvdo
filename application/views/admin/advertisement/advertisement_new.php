        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-10">
                    ...
                    <a href="<?= site_url('admin/advertisement/list'); ?>" class="btn btn-rose">Advertisement List</a>
                    <!--<button type="button" class="btn btn-rose" id="advertiser-add">New Add</button>-->
                    <a href="<?= site_url('admin/advertisement/add'); ?>" class="btn btn-success">New Add</a>
                </div>
            </div>
            ...
            <div class="row" id="advertiser-add-form">
                ...
                <div class="col-md-12">
                    <form id="RegisterValidation" action="<?= site_url('advertisement_add'); ?>" method="POST" enctype="multipart/form-data" >
                        <div class="card ">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="businessname" required="true">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-xa-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required="true" name="captionline">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                <label class="form-check-label">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="emailShow" value="1" checked=""> Show
                                            ...
                                            <div class="col-md-9" id="wt_code">
                                                <div class="form-check form-check-inline pull-right">
                                                    <label class="form-check-label">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" name="whatsappNoShow" value="1" checked=""> Show
                                                        <span class="form-check-sign">
                                                            <span class="check"></span>
                                                        </span>
                                                    </label>
                                                </div>
                                                <input type="tel" class="form-control" name="whatsappNo" id="phone" maxlength="13">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-9" id="cell_code">
                                                <div class="form-check form-check-inline pull-right">
                                                    <label class="form-check-label">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" name="cellNoShow" value="1" checked=""> Show
                                                        <span class="form-check-sign">
                                                            <span class="check"></span>
                                                        </span>
                                                    </label>
                                                </div>
                                                <input type="tel" class="form-control" name="cellNo" id="phone1" maxlength="13">
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="landLineShow" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control pane" id="editor2" name="description" rows="5" ></textarea>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="url1Show" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="url2Show" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="url3Show" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="url4Show" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="url5Show" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                            ...
                                            <div class="col-md-12 col-xs-12" >
                                                ...
                                                <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="countryShow" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="stateShow" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                ...
                                                <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="cityShow" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
...
<!--                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="postCodeShow" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline pull-right" style="margin-top: -25px;">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="LandmarkAddressShow" value="1" checked=""> Show
                                                            <span class="form-check-sign">
                                                                <span class="check"></span>
                                                            </span>
                                                        </label>
                 ...
                 <div class="row">
                     ...
                     if(!empty($this->img_limit_fix)){
                         for($i=1;$i<=$this->img_limit_fix;$i++){
                            ...
                            <div class="col-md-3 col-xs-6 text-center">
                                <center style=" cursor: pointer; margin: 2px;" id="img_div_<?= $i; ?>">
                     ...
                     ?>
<!--                     <div class="col-md-3 col-xs-6 text-center">
                         <center style=" cursor: pointer;" id="img_div_1">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                             id="render-avatar1" class="circular-fix has-shadow border marg-top10" 
                     ...
                     <div class="col-md-3 col-xs-6 text-center" >
                         <center style=" cursor: pointer;" id="img_div_2">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                             id="render-avatar2" class="circular-fix has-shadow border marg-top10" 
                     ...
                     <div class="col-md-3 col-xs-6 text-center">
                         <center style=" cursor: pointer;" id="img_div_3">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                             id="render-avatar3" class="circular-fix has-shadow border marg-top10" 
                     ...
                     <div class="col-md-3 col-xs-6 text-center">
                         <center style=" cursor: pointer;" id="img_div_4">
                             <img src="<?= base_url(); ?>theme/web/images/ads_image.png"  alt="ads image" title="Select Image"  
                             data-toggle="modal" 
                             data-target="#avatar-modal" 
                             id="render-avatar4" class="circular-fix has-shadow border marg-top10" 
...
<!--                                <div class="row">
                                    <div class="col-md-12 col-xs-12">
                                        <span class="btn btn-rose btn-file">
                                            ...
                                            <input type="file" name="video" class="btn file_multi_video" accept="video/mp4, video/wmv, video/avi, video/mov" required="true"/>
                                        </span><br>
                                        ...
                                        <div class="col-md-12 col-xs-12" id="type_append">
                                            <div id="select_div">
                                                <span class="btn btn-rose btn-file">
                                                    ...
                                                    <input type="file" name="video" class="file_multi_video" id="select_video" accept="video/mp4, video/wmv, video/avi, video/mov" required=""/>
                                                </span>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-check col-md-3">
                                            <label class="form-check-label">
                                                <input class="form-check-input" id="term" type="checkbox" value="" data-status="1" onclick="ative_btn(this)"> 
                                                <span class="form-check-sign">
                                                    <span class="check"></span>
                                                </span>
                                            </label>
                                        </div>
                                        <div class="col-md-8" style="margin-top: -17px; margin-left: 10px;">
                            ...
                            <div class="card-footer text-right pull-right">
                                ...
                                <button type="submit" disabled="true" id="term_chk" class="btn btn-rose">Submit</button>
                                <!--<input type="button" value="Submit" class="btn btn-rose" >-->
                            </div>
                        </div>
                    </form>
                </div>
...
<!--  <script src="<?= base_url(); ?>theme/backend/image-crop/js/cropper.js"></script>
  ...
  <script>
      $(document).ready(function(){
          var cell_code = $('#cell_code #country-listbox li').data('dial-code');
          $('#dial-code-cell').val(cell_code);
          
        var wt_code = $('#wt_code #country-listbox li').data('dial-code');
...
<script>
    $('.navbar-brand').text('Create New Add');
...
//        $('#select_video_view').show();
        $('#select_video_view').html('<video style="width: 50%; height: auto;" controls id="source_link_add"><source src="mov_bbb.mp4" id="video_here"></video>');
