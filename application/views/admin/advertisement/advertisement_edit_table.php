                ...
                <div class="col-md-12" id="advertiser-list-table">
                    <div class="card">
                        <div class="card-header card-header-primary card-header-icon">
                            ...
                            <h4 class="card-title">Edit Advertisement List</h4>
                        </div>
                        <div class="card-body">
                            <div class="toolbar">
                ...
                success:function(data){
                   // alert(data);
                    ...
                    var notify = $.notify('<strong>Process...</strong>', {
                        ...
                        setTimeout(function() {
                              notify.update({'type': 'success', 'message': '<strong>Success</strong> Ative This Ad...'});
   ...
   $('#status_5').on('click', function(){
    ...
    function filter_get(){
         $.ajax({
            url:'<?= site_url('filter'); ?>',
            type:'post',
            data:{use:'editads',id:id_search,from:dateFrom,to:dateTo,location:location,status:status},
            success:function(data){
                $('#filter_data').empty();
