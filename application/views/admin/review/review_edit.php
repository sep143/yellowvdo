                        ...
                        <div class="card-body">
                                <table class="table table-bordered table-striped dt-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php 
                                        if(!empty($advertiser->FirstName))
                                        echo $advertiser->FirstName.' '.$advertiser->LastName; ?></td>
                                    </tr>
                                    <tr>
                            ...
                            <form action="<?= site_url('admin/review/edit/'.$review->ID); ?>" method="POST">
                                ...
                                <hr>
                                <p>Edit Information Change Only Comment *</p>
                                <div class="card-footer pull-right">
                                    <input type="submit" name="submit" class="btn btn-rose " value="Submit">
                                </div>
                            </form>
                        </div>
                    </div>
