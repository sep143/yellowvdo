                                                ...
                                                <li class="">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink4" >
                                                            <a href="#" class="dropdown-item" id="status_1">Approve</a>
                                                            <a href="#" class="dropdown-item" id="status_2">Disapprove</a>
   ...
   $('#status_5').on('click', function(){
    ...
    function filter_get(){
         $.ajax({
            url:'<?= site_url('filter'); ?>',
            type:'post',
            data:{use:'review',id:id_search,from:dateFrom,to:dateTo,location:location,status:status},
            success:function(data){
                $('#filter_data').empty();
